...
const ContactForm = () => {
  return (
    <div>
      ...
      <h1 class="text-2xl font-bold dark:text-gray-50">Contactese con nosotros hoy</h1>

      <label for="fullname" className="text-gray-500 font-light mt-8 dark:text-gray-50">Full name<span class="text-red-500 dark:text-gray-50">*</span></label>
      ...
      <label for="email" className="text-gray-500 font-light mt-4 dark:text-gray-50">E-mail<span class="text-red-500">*</span></label>
      ...
      <label for="subject" className="text-gray-500 font-light mt-4 dark:text-gray-50">Subject<span class="text-red-500">*</span></label>
      ...
      <label for="message" className="text-gray-500 font-light mt-4 dark:text-gray-50">Message<span class="text-red-500">*</span></label>
